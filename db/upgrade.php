...
function xmldb_local_proyecto_upgrade($oldversion)
{
    ...
    if ($oldversion < 2015052800) {
        ...
        // Define table local_proyecto_archivo para ser creada.
        $table = new xmldb_table('local_proyecto_archivo');
        ...
        // Condicionalmente lanza crear tabla para local_proyeto_archivo.
        if (! $dbman->table_exists($table)) {
            $dbman->create_table($table);
        }
        
        // Bibliography savepoint reached.
        upgrade_plugin_savepoint(true, 2015052800, 'local', 'proyecto');
    }
}